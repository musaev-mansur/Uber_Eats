      ...
      <div className="header">
        ...
        <div className="right">
            ...
            <div className="profile">
                <img src={profile} alt="" />
                <a href="">{currentUser.role ? (`${currentUser.role}`) : (<Link className="turn-off" to="/sign-in">Войти</Link>)}</a>
            </div>
            ...
            {currentUser.id && (
              <button className="personal greenBack">
                <span>
                  {currentUser.id ? (
                    <Link className="turn-off" to={`/personal/${currentUser.id}`}>Личный кабинет</Link>
                  ) : (
