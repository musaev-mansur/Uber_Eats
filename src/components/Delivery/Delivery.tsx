      ...
      <div className="main">
        <div className="maps">
          <details>
              ...
              <div>
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia similique, nisi, cumque quaerat expedita nulla, ut assumenda facilis voluptate quia magni vitae architecto.</p>
              </div>
          </details>
          <details>
              <summary className="greenBack">
